  ...
  return (
    <DropdownMenuPrimitive.Item
      ...
      className={cn(
        ...
        "data-[highlighted]:[&_p]:!text-accent-foreground",
        "data-[highlighted]:[&_.text-muted-foreground]:!text-accent-foreground/75",
        ...
        "data-[variant=destructive]:data-[highlighted]:[&_p]:!text-destructive",
        "data-[variant=destructive]:data-[highlighted]:[&_.text-muted-foreground]:!text-destructive/80",
...
function DropdownMenuSubTrigger({
  ...
  return (
    <DropdownMenuPrimitive.SubTrigger
      ...
      data-inset={inset}
      className={cn(
        "flex cursor-pointer items-center gap-2 rounded-sm px-2 py-1.5 text-sm outline-hidden select-none data-[inset]:pl-8",
        "focus:bg-accent focus:text-accent-foreground",
        "data-[highlighted]:bg-accent data-[highlighted]:text-accent-foreground",
