      ...
      <div className="container mx-auto px-4 max-w-7xl">
        ...
        >
          <div className="flex items-center justify-center gap-2 text-sm text-purple-600 dark:text-purple-400 mb-3">
            ...
            <span className="font-semibold uppercase tracking-wider text-xs sm:text-sm">Customer Testimonials</span>
          </div>
          ...
          <p className="text-slate-600 dark:text-slate-400 text-base sm:text-lg leading-relaxed px-4 sm:px-0">
