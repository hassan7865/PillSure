...
const [success, setSuccess] = React.useState<string>("");
  ...
  return (
    <div className="flex w-full flex-col md:flex-row h-screen font-sans">
      ...
      <div className="w-full sm:w-1/2 flex items-center justify-center p-6 md:p-12 bg-gray-100">
        <Card className="w-full max-w-md bg-white rounded-xl shadow-md p-6">
          <CardHeader className="space-y-2 p-0 mb-6">
            <CardTitle className="text-xl font-semibold text-blue-900">Log In</CardTitle>
          ...
          <CardFooter className="p-0 pt-4 mt-4 text-center">
            <p className="text-sm text-gray-500">
              ...
              <Button
                type="button"
                variant="link"
                onClick={onSwitchToSignUp} // You need to define this function or pass it as a prop
